...
const App = (): JSX.Element => {
  ...
  const [blockFactor, setBlockFactor] = useState<number>(20);
  ...
  return (
    <div id="appContainer">
      <div id="appHeader">Transform An Image Into Building Blocks</div>
      ...
      <div id="buttons">
        ...
        <Button variant="contained" onClick={() => drawEditedImage("block")}>
          {" "}
          Turn Into Blocks{" "}
        </Button>
        <Button variant="contained" onClick={() => drawEditedImage("clear")}>
          {" "}
          Clear{" "}
        </Button>
      </div>
